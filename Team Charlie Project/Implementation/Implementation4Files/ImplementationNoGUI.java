...
public class ImplementationNoGUI {
     ...
     * @param auto Boolean whether automatic testing is on or off
     * @return integer choice of the user
     */
     ...
     * SRS 3.1.1.2, 3.1.4.3
     * @param items ArrayList of items to be displayed
     * @param userCart Cart object of the user
     * @param auto Boolean of whether automatic testing is on
     */
     ...
     * SRS 3.1.1.3
     * @param userCart Cart object of the user's cart
     * @param auto Boolean for automatic testing
     */
    ...
    /**
     * Cart editing menu allows user to remove item from cart, add item to cart, change quantity
     * checks for valid input
     * @param items ArrayList of items to reference
     * @param userCart Cart for user's cart
     * @param auto Boolean for automatic testing
     */
    ...
    */
     ...
     * @param us1 User being referenced
     * @param userCart Cart of the user being referenced
     */
     ...
     * Satisfies SRS 3.1.1.1, 3.1.1.4, 3.1.1.5, 3.1.1.6, 3.1.1.7, 3.3.3.6
     * @param items ArrayList of items from the store
     * @param userCart Cart from the user
     * @param us1 User being referenced
     * @param auto Boolean for automated testing
     */
     ...
     * @param us1 User being referenced
     * @param choice Int choice to be changed
     */
